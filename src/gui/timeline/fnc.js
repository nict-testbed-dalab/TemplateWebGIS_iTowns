...
function getZoomLevel()
{
  ...
  let objOptions = $("#timeline").k2goTimeline("getOptions");
  let intSize    = objOptions.endTime.getTime() - objOptions.startTime.getTime();
...
export { adjustCurrentTime, checkRangeBar, adjustRangeBar, changeZoomLevel, getZoomLevel, putEventInfo, makeTime, getQueryString };